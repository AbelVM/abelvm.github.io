...
5. Let's split the `potential_cell[i]` in four new square sub-cells: i0, i1, i2, i3
...
* You want your dataset [10] clustered by the spatial index above [11]
* As we want `real life` square cells, we need to use cartesian-like projection like web mercator [10]
...
* [2] : http://news.mit.edu/2015/identify-from-credit-card-metadata-0129
* [3] : http://news.mit.edu/2013/how-hard-it-de-anonymize-cellphone-data
* [4] : https://en.wikipedia.org/wiki/K-anonymity
* [5] : http://www.saladeprensa.vodafone.es/c/notas-prensa/np_vodafone_analytics/
* [6] : https://www.bbvaapimarket.com/
* [7] : https://abelvm.github.io/sql/isovists/
* [8] : https://en.wikipedia.org/wiki/Quadtree
...
* [10] : https://www.postgresql.org/docs/current/static/sql-cluster.html
* [11] : https://github.com/CartoDB/cartodb-postgresql/issues/313
* [12] : https://msdn.microsoft.com/en-us/library/bb259689.aspx
* [13] : https://github.com/javisantana
* [14] : http://javisantana.com/2014/10/22/traversing-quadtree.html
* [15] : https://github.com/CartoDB/cartodb-postgresql/blob/master/scripts-available/CDB_XYZ.sql
* [16] : https://github.com/CartoDB/QuadGrid