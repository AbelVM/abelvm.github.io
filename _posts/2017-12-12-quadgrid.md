...
* [9] : [Web Mercator](http://www.epsg-registry.org/report.htm?type=selection&entity=urn:ogc:def:crs:EPSG::3857&reportDetail=short&style=urn:uuid:report-style:default-with-code&style_name=OGP%20Default%20With%20Code&title=EPSG:3857)
* [10] : [PostgreSQL Cluster](https://www.postgresql.org/docs/current/static/sql-cluster.html)
* [11] : [Improve tile rendering time by clustering during import process @ cartodb-postgresql repo](https://github.com/CartoDB/cartodb-postgresql/issues/313)
