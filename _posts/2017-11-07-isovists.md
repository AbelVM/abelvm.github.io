...
First of all, let's think on the macro structure of it. It will need to provide us with a polygon for any input point and a set of `buildings` polygons. But... we will need some extra parameters too, like:
